...
## Parameters  Question mark    Parameters are the inputs to a function. They are specified in parentheses after the function name.    math.stretch([content],[size: ][relative],) -> [content]  
...
The size to stretch to, relative to the maximum size of the glyph and its attachments.
 ...
 Default: `100% + 0pt` 
 [SizesPrevious page] [StylesNext page]