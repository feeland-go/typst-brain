...
## Definitions  [ `circle` ] A circle with optional content. 
 [ `color` ] A color in a specific color space. 
 [ `curve` ] A curve consisting of movements, lines, and Bézier segments. 
 [ `ellipse` ] An ellipse with optional content. 
 [ `gradient` ] A color gradient. 
 [ `image` ] A raster or vector graphic. 
 [ `line` ] A line from one point to another. 
 [ `path` ] A path through a list of points, connected by Bézier curves. 
 [ `polygon` ] A closed polygon. 
 [ `rect` ] A rectangle with optional content. 
 [ `square` ] A square with optional content. 
 [ `stroke` ] Defines how to draw a line. 
 [ `tiling` ] A repeating tiling fill. 
 [StackPrevious page] [CircleNext page]