---
url: https://typst.app/docs/reference/html/frame/
category: html
topic: frame
---
...
## Parameters  Question mark    Parameters are the inputs to a function. They are specified in parentheses after the function name.    html.frame([content]) -> [content]  
...
The content that shall be laid out.
 [ElemPrevious page] [Typed HTMLNext page]