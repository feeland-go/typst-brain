...
## Definitions  [ `artifact` ] Marks content as a PDF artifact. 
 [ `attach` ] A file that will be attached to the output PDF. 
 [ `data-cell` ] Explicitly defines this cell as a data cell. 
 [ `header-cell` ] Explicitly defines a cell as a header cell. 
 [ `table-summary` ] A summary of the purpose and structure of a complex table. 
 [YAMLPrevious page] [ArtifactNext page]