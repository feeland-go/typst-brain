...
## Definitions  [ `sym` ] These two modules give names to symbols and emoji to make them easy to insert with a normal keyboard. 
 [ `emoji` ] These two modules give names to symbols and emoji to make them easy to insert with a normal keyboard. 
...
###    
 ...
 LaTeX: `` 
  ...
  [VectorPrevious page] [GeneralNext page]